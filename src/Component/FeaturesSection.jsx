...
const FeaturesSection = () => {
  return (
    <section className="max-w-7xl mx-auto py-20 px-6 text-center">
      <h2 className="text-5xl font-extrabold mb-14 text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-500">
      ...
      <div className="grid md:grid-cols-3 gap-12">
        {features.map(({ icon, title, description, bgColor }, idx) => (
          <motion.div
            ...
            className="relative bg-gray-900 rounded-3xl p-10 shadow-2xl cursor-pointer"
          >
            {/* Gradient Border */}
            <div
            ...
            {/* Card Content (on top of border) */}
            <div className="relative z-10 flex flex-col items-center">
              {/* Circle Icon Background */}
              <div
                className={`flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br ${bgColor} text-4xl drop-shadow-lg mb-6`}
              >
                {icon}
              </div>
